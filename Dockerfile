...
RUN apt-get update -y && apt-get upgrade -y \
 ...
 && mkdir -p /root/.gnupg \
 && sudo gpg --no-default-keyring --keyring /usr/share/keyrings/postgresql-archive-keyring.gpg --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys 7FCC7D46ACCC4CF8
